...
### Script to generate data that compares results between valet and frcBAM
...
OUTDIR="$(realpath ./test_data)"
RESULTS="$(realpath ./test_data/results.tsv)"
RESULTS_FRC="$(realpath ./test_data/frc_results.tsv)"
