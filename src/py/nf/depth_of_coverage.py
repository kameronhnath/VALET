...
def find_coverage_errors_scipy(mpileup_file, output_location, window_size, abundance_dict):
    """
...
def main():
    ...
    find_coverage_errors_scipy(mpile_file, options.output_location, window_size, abundance_dict)
